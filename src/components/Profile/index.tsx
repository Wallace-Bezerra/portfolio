    ...
    <S.ProfileContainer>
      <div>
        ...
        >
          ...
          <motion.p>Criando Interfaces Intuitivas e Experiências Incríveis no Desenvolvimento Web de Alto Nível</motion.p>
          <Image className='vscode-background' src="/vscode-background.svg" width={400} height={400} priority alt='' />
        </S.Emphasis>
        <S.Contact
        ...
        >
          ...
          <div className='group-button'>
            ...
            <Button id="linkedin" href="https://www.linkedin.com/in/wallace-bezerra/" target="_blank" variant="outlined"><Image src="./linkedin.svg" width="36" height="36" priority alt="icone" /></Button>
          </div>
        </S.Contact>
      </div>
      <S.ProfileUser
      ...
      >
        ...
        <div className="react-element">
          <Image src='/react-element.svg' width={50} height={50} priority alt="" />
        </div>
        <div className="icone-computer">
          <Image src='/icone-computer.svg' width={50} height={50} priority alt="" />
        </div>
